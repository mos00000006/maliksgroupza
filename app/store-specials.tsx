  ...
  return (
    <section className="storeSpecials">
      <style>{`
        ...
        .specialBranchGrid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:0;max-height:360px;overflow-y:scroll;overflow-x:hidden;padding:5px;scrollbar-gutter:stable;-webkit-overflow-scrolling:touch;overscroll-behavior:contain;scrollbar-width:auto;scrollbar-color:#7f91a6 #edf2f6}.specialBranchGrid::-webkit-scrollbar{width:10px}.specialBranchGrid::-webkit-scrollbar-track{background:#edf2f6;border-left:1px solid #dfe6ed}.specialBranchGrid::-webkit-scrollbar-thumb{background:#7f91a6;border-radius:999px;border:2px solid #edf2f6}.specialBranchGrid::-webkit-scrollbar-thumb:hover{background:#61758c}.specialBranchGrid label{display:flex;align-items:center;grid-template-columns:none;gap:7px;padding:8px;border-radius:7px;font-weight:700;cursor:pointer;min-height:42px}.specialBranchGrid label:hover{background:#f3f7fa}.specialBranchGrid input{width:16px;height:16px;flex:0 0 16px}.specialBranchGrid.disabled{opacity:.45;pointer-events:none}
        ...
        @media(max-width:720px){
          ...
          .specialBranchGrid{grid-template-columns:1fr;max-height:52dvh;overflow-y:scroll}
          .specialBranchGrid::-webkit-scrollbar{width:7px}
          .specialBranchGrid::-webkit-scrollbar-thumb{background:#7f91a6;border:1px solid #edf2f6}
