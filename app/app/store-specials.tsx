  ...
  return (
    <section className="storeSpecials">
      <style>{`
        ...
        .specialCarousel,.specialNoImage{position:relative;background:#e8edf3;overflow:hidden;min-height:360px}
        .specialCarousel{display:grid;place-items:center;perspective:1400px;touch-action:pan-y}
        .specialFlipStage{width:100%;height:100%;min-height:360px;display:grid;place-items:center;transform-style:preserve-3d;transform-origin:center;transition:transform .34s ease,opacity .2s ease;background:#eef2f6}
        .specialFlipStage img{width:100%;height:auto;max-height:76vh;object-fit:contain;display:block;background:#fff}
        ...
        .specialCarouselPrev,.specialCarouselNext{position:absolute;top:50%;transform:translateY(-50%);width:44px;height:58px;border:1px solid #ffffff55;border-radius:12px;background:#172438dd;color:#fff;font-size:29px;cursor:pointer;box-shadow:0 8px 22px #17243833;z-index:4}.specialCarouselPrev{left:14px}.specialCarouselNext{right:14px}.specialCarouselPrev:hover,.specialCarouselNext:hover{background:#203a58}
        .specialDots{position:absolute;bottom:12px;left:50%;transform:translateX(-50%);display:flex;gap:6px;z-index:4;background:#17243899;border-radius:999px;padding:5px 8px}.specialDots button{width:7px;height:7px;padding:0;border:0;border-radius:999px;background:#ffffff99}.specialDots button.active{width:20px;background:#f5ca2e}
        .specialSlideCount{position:absolute;right:12px;bottom:10px;background:#172438d8;color:#fff;border-radius:999px;padding:5px 8px;font-size:7px;font-weight:800;z-index:4}
        .specialSwipeHint{display:none;position:absolute;left:12px;bottom:10px;background:#172438c7;color:#fff;border-radius:999px;padding:5px 8px;font-size:7px;font-weight:750;z-index:4}
        ...
        @media(max-width:720px){
          ...
          .specialCarousel,.specialNoImage{min-height:0}
          .specialFlipStage{min-height:0;width:100%}
