...
export default function RolloutOnboardingCentre({
  ...
  return (
    <section className="rolloutCentre">
      <style>{`
        .rolloutCentre{display:grid;gap:14px;padding-bottom:45px}.rolloutLoading{background:#fff;border:1px solid #dce5ed;border-radius:13px;padding:24px;color:#64778a}.rolloutToast{position:fixed;top:92px;right:22px;z-index:120;background:#fff;border:1px solid #d7e1e9;border-radius:10px;padding:10px 13px;box-shadow:0 18px 45px #1724382b;color:#365069;font-size:8.5px;font-weight:850}.rolloutHero{background:linear-gradient(125deg,#14263d,#254a69);border-radius:17px;padding:20px 22px;color:#fff;display:grid;grid-template-columns:1fr auto;gap:15px;align-items:center}.rolloutHero small{display:block;color:#f5ca2e;font-size:8px;font-weight:950;letter-spacing:.13em}.rolloutHero h2{font-size:24px;margin:5px 0}.rolloutHero p{margin:0;color:#cedae5;font-size:9px;line-height:1.55;max-width:780px}.rolloutHeroActions{display:flex;gap:7px;flex-wrap:wrap;justify-content:flex-end}.rolloutHeroActions button{height:39px;border:1px solid #ffffff35;border-radius:9px;background:#fff;color:#27435c;padding:0 12px;font:inherit;font-size:8px;font-weight:900;cursor:pointer}.rolloutHeroActions .yellow{background:#f5ca2e;border-color:#ddb91e;color:#172438}.rolloutStatus{margin-top:9px;display:inline-flex;align-items:center;gap:7px;border-radius:999px;padding:6px 9px;background:#ffffff14;border:1px solid #ffffff24;font-size:7px;font-weight:850}.rolloutStatus i{width:9px;height:9px;border-radius:50%;background:#f2b93b}.rolloutStatus.ready i{background:#28ad78}.rolloutCards{display:grid;grid-template-columns:repeat(6,1fr);gap:9px}.rolloutCard{background:#fff;border:1px solid #dce5ed;border-radius:12px;padding:13px}.rolloutCard span{display:block;color:#7c8997;font-size:7px;text-transform:uppercase;font-weight:900}.rolloutCard b{display:block;font-size:21px;color:#243e56;margin-top:5px}.rolloutCard small{display:block;color:#8996a3;font-size:7px;margin-top:3px}.rolloutGrid{display:grid;grid-template-columns:1.15fr .85fr;gap:11px}.rolloutPanel{background:#fff;border:1px solid #dce5ed;border-radius:13px;padding:14px}.rolloutPanelHeader{display:flex;justify-content:space-between;gap:10px;align-items:center;margin-bottom:11px}.rolloutPanelHeader h3{margin:0;color:#263f57;font-size:13px}.rolloutPanelHeader p{margin:3px 0 0;color:#81909f;font-size:7.5px}.rolloutPanelHeader button{border:1px solid #d4dee7;background:#fff;border-radius:8px;padding:7px 9px;font:inherit;font-size:7px;font-weight:850;color:#36516b;cursor:pointer}.rolloutProgressList{display:grid;gap:9px}.rolloutProgressRow{border:1px solid #e1e7ed;border-radius:9px;padding:10px}.rolloutProgressTop{display:flex;justify-content:space-between;gap:10px;font-size:7.5px;font-weight:850;color:#405970}.rolloutBar{height:8px;background:#edf2f6;border-radius:999px;margin-top:7px;overflow:hidden}.rolloutBar span{display:block;height:100%;background:#f4c82b;border-radius:999px}.roleGrid{display:grid;grid-template-columns:1fr 1fr;gap:7px}.roleCard{border:1px solid #e0e7ed;border-radius:9px;padding:9px;background:#fbfcfd}.roleCard b{display:block;color:#304a62;font-size:8px}.roleCard small{display:block;color:#84919e;font-size:6.5px;margin-top:3px}.roleBar{height:6px;background:#ebf0f4;border-radius:99px;margin-top:6px;overflow:hidden}.roleBar span{display:block;height:100%;background:#2b587d;border-radius:99px}.rolloutToolbar{display:flex;justify-content:space-between;gap:10px;align-items:center;flex-wrap:wrap}.rolloutFilters{display:flex;gap:5px;flex-wrap:wrap}.rolloutFilters button{border:1px solid #d6e0e8;background:#fff;border-radius:999px;padding:6px 9px;font:inherit;font-size:6.5px;font-weight:850;color:#587086;cursor:pointer}.rolloutFilters button.active{background:#172d46;color:#fff;border-color:#172d46}.rolloutTableWrap{overflow:auto;border:1px solid #e0e7ed;border-radius:10px;margin-top:10px}.rolloutTable{width:100%;border-collapse:collapse;min-width:1080px}.rolloutTable th,.rolloutTable td{text-align:left;padding:9px 9px;border-bottom:1px solid #e8edf1;font-size:7px;color:#52687d;vertical-align:middle}.rolloutTable th{background:#f7f9fb;color:#738292;text-transform:uppercase;font-size:6.2px;font-weight:900;position:sticky;top:0}.rolloutTable tr:last-child td{border-bottom:0}.rolloutTable b{display:block;color:#2e485f;font-size:8px}.rolloutTable small{display:block;color:#8a97a4;font-size:6.3px;margin-top:2px}.rolloutTable button{border:1px solid #d4dee7;background:#fff;border-radius:7px;padding:6px 8px;font:inherit;font-size:6.5px;font-weight:850;color:#36516b;cursor:pointer}.rolloutTag{display:inline-flex;border-radius:999px;padding:4px 7px;background:#edf2f6;color:#5e7285;font-size:6.3px;font-weight:850}.rolloutTag.good{background:#def4e8;color:#176b49}.rolloutTag.warn{background:#fff0ca;color:#8a6200}.rolloutTag.bad{background:#f8e3e5;color:#a13c48}.rolloutCheck{font-size:11px;font-weight:950}.rolloutCheck.yes{color:#17906a}.rolloutCheck.no{color:#c44b58}
        @media(max-width:1180px){.rolloutCards{grid-template-columns:repeat(3,1fr)}.rolloutGrid{grid-template-columns:1fr}}
        @media(max-width:720px){.rolloutCards{grid-template-columns:1fr 1fr}.roleGrid{grid-template-columns:1fr}.rolloutHero{grid-template-columns:1fr}.rolloutHeroActions{justify-content:flex-start}}
      `}</style>
