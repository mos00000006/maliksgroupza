  ...
  return (
    <section className="storeSpecials">
      <style>{`
        ...
        .specialBranchGrid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:0;max-height:230px;overflow-y:auto;overflow-x:hidden;padding:5px 10px 5px 5px;scrollbar-gutter:stable both-edges;-webkit-overflow-scrolling:touch;overscroll-behavior:contain;scrollbar-width:auto;scrollbar-color:#5f748c #e7edf3}.specialBranchGrid::-webkit-scrollbar{width:14px}.specialBranchGrid::-webkit-scrollbar-track{background:#e7edf3;border-left:1px solid #d3dde7;border-radius:999px}.specialBranchGrid::-webkit-scrollbar-thumb{background:#5f748c;border-radius:999px;border:3px solid #e7edf3;min-height:46px}.specialBranchGrid::-webkit-scrollbar-thumb:hover{background:#415a74}.specialBranchGrid label{display:flex;align-items:center;grid-template-columns:none;gap:7px;padding:8px;border-radius:7px;font-weight:700;cursor:pointer;min-height:42px}.specialBranchGrid label:hover{background:#f3f7fa}.specialBranchGrid input{width:16px;height:16px;flex:0 0 16px}.specialBranchGrid.disabled{opacity:.45;pointer-events:none}
        ...
        @media(max-width:720px){
          ...
          .specialBranchGrid{grid-template-columns:1fr;max-height:42dvh;overflow-y:auto;padding-right:8px}
          .specialBranchGrid::-webkit-scrollbar{width:10px}
          .specialBranchGrid::-webkit-scrollbar-track{background:#e7edf3;border-radius:999px}
          .specialBranchGrid::-webkit-scrollbar-thumb{background:#5f748c;border:2px solid #e7edf3;border-radius:999px;min-height:42px}
