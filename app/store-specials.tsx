  ...
  return (
    <section className="storeSpecials">
      <style>{`
        ...
        .specialBranchBox{border:1px solid #dce4ec;border-radius:11px;overflow:visible!important;height:auto!important;max-height:none!important;min-height:214px!important}.specialBranchHeader{display:flex;justify-content:space-between;gap:10px;align-items:center;padding:10px 12px;background:#f7f9fb;border-bottom:1px solid #e5ebf0}.specialBranchHeader b{font-size:9px;color:#344b62}.specialAllToggle{display:flex!important;grid-auto-flow:column;align-items:center;gap:7px!important;font-size:8px!important}.specialAllToggle input{width:17px;height:17px}
        .specialBranchGrid{display:grid!important;grid-template-columns:repeat(5,minmax(0,1fr))!important;grid-template-rows:repeat(4,34px)!important;grid-auto-flow:row!important;gap:4px 8px!important;padding:7px 10px 9px!important;background:#fff!important;height:160px!important;max-height:160px!important;min-height:160px!important;overflow:visible!important;box-sizing:border-box!important}.specialBranchGrid label{display:flex!important;align-items:center!important;gap:7px!important;padding:3px 6px!important;border-radius:7px!important;font-weight:700!important;cursor:pointer!important;min-height:34px!important;height:34px!important;overflow:visible!important;white-space:normal!important;line-height:1.15!important;box-sizing:border-box!important}.specialBranchGrid label:hover{background:#f3f7fa}.specialBranchGrid input{width:16px;height:16px;flex:0 0 16px}.specialBranchGrid.disabled{opacity:.45;pointer-events:none}
        ...
        @media(max-width:1200px){.specialBranchGrid{grid-template-columns:repeat(4,minmax(0,1fr))!important;grid-template-rows:none!important;height:auto!important;max-height:none!important;min-height:0!important}}@media(max-width:900px){.specialGrid{grid-template-columns:1fr}.specialKpis{grid-template-columns:1fr 1fr}.specialBranchGrid{grid-template-columns:repeat(2,minmax(0,1fr))!important;grid-template-rows:none!important;height:auto!important;max-height:none!important;min-height:0!important}}
        @media(max-width:720px){
          ...
          .specialBranchGrid{grid-template-columns:1fr!important;grid-template-rows:none!important;padding:6px 7px 14px!important;height:auto!important;max-height:none!important;min-height:0!important;overflow:visible!important}
