  ...
  return (
    <section className="storeSpecials">
      <style>{`
        ...
        .specialBranchGrid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:0;max-height:300px;overflow-y:scroll;overflow-x:hidden;padding:5px 12px 14px 5px;-webkit-overflow-scrolling:touch;overscroll-behavior:contain;scrollbar-gutter:stable;scrollbar-width:thin;scrollbar-color:#56718f #edf2f6}.specialBranchGrid::-webkit-scrollbar{width:9px}.specialBranchGrid::-webkit-scrollbar-button{display:none!important;width:0!important;height:0!important}.specialBranchGrid::-webkit-scrollbar-track{background:#edf2f6;border-radius:999px;margin:7px 0}.specialBranchGrid::-webkit-scrollbar-thumb{background:#56718f;border-radius:999px;border:2px solid #edf2f6;min-height:54px}.specialBranchGrid::-webkit-scrollbar-thumb:hover{background:#365675}.specialBranchGrid::-webkit-scrollbar-thumb:active{background:#244766}.specialBranchGrid label{display:flex;align-items:center;grid-template-columns:none;gap:7px;padding:9px 8px;border-radius:7px;font-weight:700;cursor:pointer;min-height:44px}.specialBranchGrid label:hover{background:#f3f7fa}.specialBranchGrid input{width:16px;height:16px;flex:0 0 16px}.specialBranchGrid.disabled{opacity:.45;pointer-events:none}
        ...
        @media(max-width:720px){
          ...
          .specialBranchGrid{grid-template-columns:1fr;max-height:48dvh;overflow-y:scroll;padding-right:8px;padding-bottom:14px;scrollbar-width:thin}
          .specialBranchGrid::-webkit-scrollbar{width:7px}
          .specialBranchGrid::-webkit-scrollbar-button{display:none!important;width:0!important;height:0!important}
          .specialBranchGrid::-webkit-scrollbar-track{background:#edf2f6;border-radius:999px;margin:6px 0}
          .specialBranchGrid::-webkit-scrollbar-thumb{background:#56718f;border:1px solid #edf2f6;border-radius:999px;min-height:48px}
            ...
            <div className="specialModalBody">
              ...
              <div className="specialBranchBox">
                <div className="specialBranchHeader">
                  <b>Branches running this special <span style={{color:"#8291a2",fontWeight:700}}>({data.branches.length})</span></b>
